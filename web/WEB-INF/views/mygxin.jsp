				...
				<div class="you fl">
					<div class="tx clearfix">
						<div class="fl clearfix">
							<p class="fl"><span style="font-size: large">欢迎您:${sessionScope.user.username}</span></p>
						</div>
					...
					<div class="bott">
						<div class="clearfix">
							...
							<p class="fl"><span>订单<strong></strong></span>
								<a href="${path}/personalOrder">查看订单></a>
							</p>
						</div>
						<div class="clearfix">
							<a href="#" class="fl"><img src="${path}/img/gxin2.jpg"/></a>
							<p class="fl"><span>我的收货地址<strong></strong></span>
								<a href="${path}/address">查看收货地址></a>
							</p>
						</div>
					<%--	<div class="clearfix">
							<a href="#" class="fl"><img src="${path}/img/gxin3.jpg"/></a>
							<p class="fl"><span>待评价的订单：<strong>0</strong></span>
								<a href="${path}/WEB-INF/views/myprod.jsp">查看待评价订单></a>
							</p>
						</div>
						<div class="clearfix">
