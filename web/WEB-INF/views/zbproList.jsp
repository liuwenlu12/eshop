		...
		<div class="current">
			<div class="wrapper clearfix">
				...
				<c:forEach items="${requestScope.brands}" var="brand">
					<a  class="name-brand" href="${path}/list?<c:if test="${param.typeId!=null}">typeId=${param.typeId}&</c:if>brandId=${brand.brand_id}">${brand.brand_name}</a>
				...
				<li>
					<a href="${path}/detail?productId=${product.product_id}">
						<dl>
							...
							<a href="${path}/detail?productId=${product.product_id}" title="${product.product_name}">${product.product_name}</a>
				...
				<div class="fr">
					<div class="proIntro">
						...
						<div class="smallImg clearfix categ">
							<p class="fl"><img src="${path}/img/temp/prosmall01.jpg" alt="白瓷花瓶+20支快乐花" data-src="${path}/img/temp/proBig01.jpg"></p>
							<p class="fl"><img src="${path}/img/temp/prosmall02.jpg" alt="白瓷花瓶+20支兔尾巴草" data-src="${path}/img/temp/proBig02.jpg"></p>
							<p class="fl"><img src="${path}/img/temp/prosmall03.jpg" alt="20支快乐花" data-src="${path}/img/temp/proBig03.jpg"></p>
							<p class="fl"><img src="${path}/img/temp/prosmall04.jpg" alt="20支兔尾巴草" data-src="${path}/img/temp/proBig04.jpg"></p>
						</div>
