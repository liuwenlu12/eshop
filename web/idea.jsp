...
<html>
	...
	<body>
		...
		<div class="imgList1">
			<div class="wrapper">
				<div class="box1">
					<a href="WEB-INF/views/proDetail.jsp" class="banner"><img src="img/idea1.jpg"/></a>
					<ul>
						<li><a href="WEB-INF/views/proDetail.jsp">
								<dl>
				...
				<div class="box2">
					<a href="WEB-INF/views/proDetail.jsp" class="banner"><img src="img/idea22.jpg"/></a>
					<ul>
						<li><a href="WEB-INF/views/proDetail.jsp" class="on">
								<dl>
