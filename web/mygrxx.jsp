...
<html>
	...
	<body>
		...
		<div class="address mt">
			<div class="wrapper clearfix">
				<a href="WEB-INF/views/index.jsp" class="fl">首页</a>
				<span>/</span>
				<a href="WEB-INF/views/mygxin.jsp" class="on">个人信息</a>
			</div>
		</div>
			...
			<div class="wrapper clearfix">
				<div class="zuo fl">
					...
					<div>
						<h4>我的交易</h4>
						<ul>
							<li><a href="WEB-INF/views/cart.jsp">我的购物车</a></li>
							<li><a href="WEB-INF/views/myorderq.jsp">我的订单</a></li>
							<li><a href="WEB-INF/views/myprod.jsp">评价晒单</a></li>
						</ul>
						<h4>个人中心</h4>
						<ul>
							<li><a href="WEB-INF/views/mygxin.jsp">我的中心</a></li>
							<li><a href="WEB-INF/views/address.jsp">地址管理</a></li>
						</ul>
						<h4>账户管理</h4>
						<ul>
							<li  class="on"><a href="mygrxx.jsp">个人信息</a></li>
							<li><a href="WEB-INF/views/remima.jsp">修改密码</a></li>
						</ul>
					</div>
				</div>
				<div class="you fl">
